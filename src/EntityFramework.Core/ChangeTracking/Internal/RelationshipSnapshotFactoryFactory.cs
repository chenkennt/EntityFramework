...
namespace Microsoft.Data.Entity.ChangeTracking.Internal
{
    ...
    {
        private static readonly MethodInfo _snapshotColectionMethod
            = typeof(RelationshipSnapshotFactoryFactory).GetTypeInfo().GetMethod(nameof(SnapshotCollection));

        private static readonly MethodInfo _readShadowValueMethod
            = typeof(InternalEntityEntry).GetTypeInfo().GetMethod(nameof(InternalEntityEntry.ReadShadowValue));
        ...
        [UsedImplicitly]
        public static HashSet<object> SnapshotCollection([CanBeNull] IEnumerable collection)
        {
            if (collection == null)
            {
                return null;
